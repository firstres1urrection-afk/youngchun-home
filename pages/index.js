...
export default function Home() {
  ...
  return (
    <>
      ...
      <main style={{ fontFamily: 'sans-serif', margin: '0 auto', padding: '20px', maxWidth: '800px' }}>
        ...
        <section>
          ...
          <button onClick={handleCheckout} style={{ padding: '10px 20px', backgroundColor: '#0070f3', color: '#fff', border: 'none', borderRadius: '4px', cursor: 'pointer' }}>베타 이용권 구매 (₩5,000)</button>
        </section>
      </main>
    </>
  );
